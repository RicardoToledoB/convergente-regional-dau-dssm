...
## v4.2
Incluye Gestión Red responsiva, filtros múltiples reales, Bitácora corregida y exportación CSV validada por tab.

## v4.2.2 hotfix reportería
- Corrige recepción de `fechaAdminision` y acepta también `fechaAdmision` como alias de compatibilidad.
